...
def test_serve_model_keras() -> object:  # type: ignore[return]
    """Initialize function test_serve_model_keras."""
...
def test_serve_model_keras_missing() -> object:  # type: ignore[return]
    """Initialize function test_serve_model_keras_missing."""
