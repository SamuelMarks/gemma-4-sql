...
def export_model(model_name: str, export_path: str, backend: str = "jax", **kwargs: Any) -> JSONDict:
    ...
    Args:
        ...
        **kwargs: Optional additional keyword arguments passed to the backend export.
